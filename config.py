#batch_size = 50 ## adjust this number to fit in memory capacity of your GPU
#num_action = 500 ## number of candidates push actions to be sampled from current image, the number should be a multiple of batch_size
